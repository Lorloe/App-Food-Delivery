package com.eddie.appbanhang.activity;
...
import com.eddie.appbanhang.adapter.TieudungBaseAdapter;
import com.eddie.appbanhang.model.Sanpham;
import com.eddie.appbanhang.ultil.CheckConnection;
import com.eddie.appbanhang.ultil.Server;
...
public class TieudungActivity extends AppCompatActivity {
    ListView lvdt;
    Toolbar toolbar;
    ArrayList<Sanpham> sanphamArrayList;
    TieudungBaseAdapter tieudungBaseAdapter;
    View footerView;
    boolean isLoading;
    mHandler mHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tieudung);
        AnhXa();
...
//           Getspdt();
    ...
    private void LoadModedata() {
        lvdt.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(TieudungActivity.this,ChiTietSPActivity.class);
    ...
    private void Getdata(int page) {
        ...
        String duongdan = Server.DuongDanHangHoa + String.valueOf(page);
                ...
                if (response != null && response.length() != 2) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            tieudungBaseAdapter.notifyDataSetChanged();
                        }
    ...
    private void AnhXa() {
        toolbar = findViewById(R.id.toolbar_maintieudung);
        lvdt = findViewById(R.id.lv_tieudung);
        sanphamArrayList = new ArrayList<>();
        tieudungBaseAdapter = new TieudungBaseAdapter(getApplicationContext(), sanphamArrayList);
        lvdt.setAdapter(tieudungBaseAdapter);
