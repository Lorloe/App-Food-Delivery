...
import com.eddie.appbanhang.adapter.ThucPhamBaseAdapter;
...
public class ThucphamActivity extends AppCompatActivity {
    ...
    ThucPhamBaseAdapter thucPhamBaseAdapter;
    int idlaptop = 0;
    int page = 1;
    ...
    private void LoadModeData() {
        lvlaptop.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent intent = new Intent(ThucphamActivity.this, ChiTietSPActivity.class);
...
public class ThreadLaptop extends Thread{
    ...
    private void AnhXa() {
        toolbar = findViewById(R.id.toolbar_mainthucpham);
        lvlaptop = findViewById(R.id.lv_thucpham);
        listLaptop = new ArrayList<>();
        thucPhamBaseAdapter = new ThucPhamBaseAdapter(getApplicationContext(), listLaptop);
        lvlaptop.setAdapter(thucPhamBaseAdapter);
        LayoutInflater layoutInflater = (LayoutInflater) getSystemService(LAYOUT_INFLATER_SERVICE);
        footerViewLT = layoutInflater.inflate(R.layout.progress_load,null);
                ...
                if (response != null && response.length() != 2) {
                    ...
                    try {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            thucPhamBaseAdapter.notifyDataSetChanged();
                        }
