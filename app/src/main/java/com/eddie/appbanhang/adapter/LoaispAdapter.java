...
import com.eddie.appbanhang.activity.TieudungActivity;
import com.eddie.appbanhang.activity.ThucphamActivity;
import com.eddie.appbanhang.R;
import com.eddie.appbanhang.model.Loaisp;
    ...
    public void onBindViewHolder(@NonNull LoaispAdapter.ViewHolder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                switch (position){
                    case 0:
                        Intent intent1 = new Intent(context, ThucphamActivity.class);
                        intent1.putExtra("idloaisanpham",listLoaisp.get(position).getId());
                        intent1.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                        context.startActivity(intent1);
                        break;
                    case 1:
                        Intent intent = new Intent(context, TieudungActivity.class);
