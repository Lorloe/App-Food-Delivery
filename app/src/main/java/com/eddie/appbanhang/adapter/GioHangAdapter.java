...
import com.eddie.appbanhang.activity.GioHangActivity;
import com.eddie.appbanhang.activity.MainActivity;
...
public class GioHangAdapter extends BaseAdapter {
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            viewHolder.tvTenGioiH = view.findViewById(R.id.tv_tengiohang);
